...
abstract class BaseGameListPeer
{
    ...
    public static function doCountJoinBonus(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GameListPeer::IDBONUS, BonusPeer::IDBONUS, $join_behavior);
    ...
    public static function doCountJoinPlayer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GameListPeer::IDPLAYER, PlayerPeer::IDPLAYER, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related GameRelatedByIdgame table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinGameRelatedByIdgame(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(GameListPeer::IDGAME, GamePeer::IDGAME, $join_behavior);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinGameRelatedByIdgame(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                $obj2->addGameListRelatedByIdgame($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key4 !== null) {
                ...
                $obj4->addGameListRelatedByIdgame($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptGameRelatedByIdgame(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptBonus(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = GameListPeer::getInstanceFromPool($key1))) {
                ...
                $obj3->addGameListRelatedByIdgame($obj1);
    ...
    /**
     * Selects a collection of GameList objects pre-filled with all related objects except GameRelatedByIdgame.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptGameRelatedByIdgame(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(GameListPeer::IDGAME) && $criteria->keyContainsValue(GameListPeer::IDGAME) ) {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += GameListPeer::doOnDeleteCascade(new Criteria(GameListPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += GameListPeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    GameListPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = GameListPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(GamePeer::IDGAME, $obj->getIdgame());
